...
> ::: info 核心思想
>
> <b>插入排序 （Insertion Sort）</b>的核心思想是 ‌<b>“分治有序”，通过 逐步构建有序子序列</b> 的方式完成排序。
>
> :::
...
> <b>插入排序 （Insertion Sort）</b>的核心思想是 ‌<b>“逐步构建有序序列”，通过分治有序区与无序区，并 ‌动态插入</b> 完成排序。虽然效率不如高级算法（如快速排序、归并排序），但其简单性和稳定性使其在特定场景下仍具实用价值。
